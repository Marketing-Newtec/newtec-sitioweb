...
export const OriginSection: React.FC = () => {
  return (
    <section id="alianza" className="py-24 md:py-48 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
        <div className="lg:w-1/2">
          {/* Contenedor de Banderas - Ajustado tamaño para móvil */}
          <motion.div 
          ...
          >
            ...
            <motion.div 
              ...
              className="flex flex-col w-16 h-10 md:w-24 md:h-14 rounded-lg md:rounded-xl overflow-hidden shadow-2xl border border-white/20 aura-glow"
            >
          ...
          {/* Título: Ajuste fluido para móvil y laptop 1440px */}
          <motion.h2 
          ...
          >
            {/* Bajada: Reducida para laptops para no verse gigante */}
            <p className="text-xl md:text-2xl lg:text-xl xl:text-2xl text-purple-100/90 font-light leading-relaxed italic">
        ...
        <div className="lg:w-1/2 w-full relative group">
          <motion.div 
            ...
            className="relative z-10 aura-glow rounded-[2.5rem] md:rounded-[4rem] overflow-hidden border border-white/10"
          >
            ...
            <img 
              ...
              className="w-full h-[400px] md:h-[600px] object-cover transition-transform duration-[3s] group-hover:scale-110" 
            />
            <div className="absolute inset-0 z-20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-700 bg-black/40 backdrop-blur-sm">
               <div className="text-center">
                  ...
                  <p className="text-white text-xs md:text-sm font-brand font-black tracking-widest uppercase">Calidad Global</p>
               </div>
            </div>
          </motion.div>
          
          {/* Badge "Tecnología y Calidad" - Oculto en móviles muy pequeños */}
          <motion.div 
            animate={{ y: [0, -10, 0] }}
            transition={{ repeat: Infinity, duration: 4 }}
            className="absolute -bottom-10 -right-4 md:-bottom-16 md:-right-10 bg-white p-6 md:p-12 rounded-[2rem] md:rounded-[3.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] z-20 hidden xs:block"
          >
            <p className="text-[#592B82] font-brand font-black text-xl md:text-4xl italic leading-none">
