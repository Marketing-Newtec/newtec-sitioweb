      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-10">
          <FeatureCard 
            ...
            desc="Operamos procesos de llenado aséptico en ambientes clasificados ISO 5, bajo estrictos estándares GMP, asegurando la integridad del producto y la máxima seguridad para el paciente."
            icon={
