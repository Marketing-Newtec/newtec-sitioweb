...
// We unify the stroke to 1.2 so that simple line icons do not overshadow the microscope
...
const FeatureCard: React.FC<{ title: string; desc: string; icon: React.ReactNode; delay: number }> = ({ title, desc, icon, delay }) => (
  ...
  >
    {icon}
    {/* Size adjustment to ensure a single line on long titles */}
    ...
    <section id="tecnología" className="py-12 md:py-40 px-6 relative">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end gap-10 md:gap-12 mb-16 md:mb-32 text-center lg:text-left">
          ...
          >
            One of our core strengths lies in the continuous investment in cutting-edge infrastructure, positioning ourselves as one of the most modern laboratories in Argentina.
          </motion.p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-10">
          <FeatureCard 
            delay={0.2}
            title="Sterile Powders"
            desc="We operate aseptic filling processes in ISO 5 classified environments, under strict GMP standards, ensuring product integrity and maximum patient safety, using the highest quality raw materials."
            icon={
          ...
          <FeatureCard 
            ...
            desc="We feature state-of-the-art technology and automated systems that minimize manual intervention, guaranteeing precision, reproducibility, and stability in every production process."
            icon={
              <IconWrapper>
          ...
          <FeatureCard 
            ...
            desc="Our robust quality system ensures full traceability, rigorous analytical control, and regulatory compliance, supporting the release of each batch with the highest standards in the pharmaceutical industry."
            icon={
              <IconWrapper>
